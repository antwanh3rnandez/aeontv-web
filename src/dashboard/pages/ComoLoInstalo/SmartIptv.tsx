  ...
  return (
    <div className="flex-col md:flex">
      <div className="relative w-full bg-black h-[220px]">
        <HeroPages title="Instalar AeonTV (SmartTV con SmartIPTV)"/>
                    ...
                    <div className="grid lg:grid-cols-3 items-start justify-center">
                        ...
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <div className="py-4 lg:mt-0 text-center lg:text-center">
                                ...
                                <p className="font-light p-4">Ahora en una computadora, ingresa a: <a href="http://siptv.eu/mylist" target="_blank" className="text-greenprimary">http://siptv.eu/mylist</a></p>
