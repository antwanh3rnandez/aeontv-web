  ...
  return (
    <div className="flex-col md:flex">
      <div className="relative w-full bg-black h-[220px]">
        <HeroPages title="Instalar AeonTV (SmartTV con SSIPTV)"/>
                    ...
                    <div className="grid lg:grid-cols-3 items-start justify-center">
                        <div className="flex flex-col items-center justify-center">
                            <div className="border-2 border-greenprimary w-24 h-24 rounded-full flex flex-col items-center justify-center">
                                <IconInfoTriangleFilled size={48} className="text-greenprimary"/>
                            </div>
                            <div className="py-4 lg:mt-0 text-center lg:text-center">
                                <h4 className="font-semibold">PASO 1</h4>
                                <p className="font-light p-4">Deberá obtener su lista M3U para eso ingresará a su navegador a: <a href="http://cuenta.aeontv.com.mx" target="_blank" className="text-greenprimary">http://cuenta.aeontv.com.mx</a></p>
                        ...
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <div className="py-4 lg:mt-0 text-center lg:text-center">
                                ...
                                <p className="font-light p-4"><a href="https://bit.ly/3iB0Dzq" target="_blank" className="text-greenprimary">https://bit.ly/3iB0Dzq</a></p>
                            </div>
                        </div>
                        <div className="flex flex-col items-center justify-center">
                            <div className="border-2 border-greenprimary w-24 h-24 rounded-full flex flex-col items-center justify-center">
                            ...
                            <div className="py-4 lg:mt-0 text-center lg:text-center">
                                ...
                                <p className="font-light p-4">Una vez instalada la abrimos para ver cual es nuestro «Código de Conexión«. Después vamos a: <a href="https://bit.ly/3yzCDCp" target="_blank" className="text-greenprimary">https://bit.ly/3yzCDCp</a>, e ingresamos nuestro código de conexión.</p>
                            </div>
                        </div>
                    </div>
                    <div className="grid lg:grid-cols-2 items-start justify-center">
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <div className="py-4 lg:mt-0 text-center lg:text-center">
                                ...
                                <p className="font-light p-4">Seleccionamos «<b>External Playlist</b>» y luego «<b>Add</b>«, en «<b>Playlist URL</b>» ingresamos el url que obtuvimos en el paso 1 y en donde dice «<b>Playlist Title</b>» escribimos «<b>AeonTV</b>«, oprimimos «<b>Save</b>«.</p>
                            </div>
                        </div>
                        <div className="flex flex-col items-center justify-center">
                            <div className="border-2 border-greenprimary w-24 h-24 rounded-full flex flex-col items-center justify-center">
                            ...
                            <div className="py-4 lg:mt-0 text-center lg:text-center">
                                ...
                                <p className="font-light p-4">Una vez guardamos los cambios, regresamos a la pantalla principal y veremos nuestra lista llamada «<b>AeonTV</b>» ya cargada en la aplicación.</p>
                                <p className="p-4"><em className="text-greenprimary">¡Listo! Ahora puede acceder al contenido.</em></p>
                            </div>
                        </div>
                    </div>
                </Card>
